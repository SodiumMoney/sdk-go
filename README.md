...
```bash
go get github.com/SodiumMoney/sdk-go
```

## Usage

```go
import sodium "github.com/SodiumMoney/sdk-go"

addr, err := sodium.GetPaymentAddress("twitter", "@blknoiz06", sodium.Mainnet)
```
